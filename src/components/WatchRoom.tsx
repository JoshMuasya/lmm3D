...
const WatchRoom: React.FC<WatchRoomProps> = ({ watch, onBack }) => {
    ...
    return (
        <group>
            ...
            {/* 🧱 Floor & Ceiling */}
            <Wall position={[0, 0, 0]} args={[roomWidth, 0.1, roomDepth]} color="#8b3a3a" />
            <Wall position={[0, roomHeight, 0]} args={[roomWidth, 0.1, roomDepth]} color="#4A0E0E" />

            {/* 🧱 Walls */}
            <Wall position={[0, roomHeight / 2, -roomDepth / 2]} args={[roomWidth, roomHeight, 0.1]} color="#2E0A0A" />
            <Wall position={[0, roomHeight / 2, roomDepth / 2]} args={[roomWidth, roomHeight, 0.1]} color="#2E0A0A" />
            <Wall position={[-roomWidth / 2, roomHeight / 2, 0]} args={[0.1, roomHeight, roomDepth]} color="#2E0A0A" />
            <Wall position={[roomWidth / 2, roomHeight / 2, 0]} args={[0.1, roomHeight, roomDepth]} color="#2E0A0A" />
